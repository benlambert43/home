...
export const ApiMessage = {
  ...
  ENDPOINT_NOT_FOUND:
    "That endpoint does not exist. Please check the request method and address.",
  ...
  POST_CHANGED_SINCE_LOADED:
    "This post was changed since you loaded it for editing. Please reload and try again.",
